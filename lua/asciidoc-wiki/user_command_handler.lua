...
M.buf_setup = function()
  ...
  -- api.nvim_buf_create_user_command(0, 'WikiGoBackLink', link_handler.go_backlink, {})
  api.nvim_buf_create_user_command(0, "WikiIndex", function(opts)
    func.wiki_index(tonumber(opts.args))
  end, { nargs = "?" })
  api.nvim_buf_create_user_command(0, "WikiSearch", func.wiki_search, { nargs = 0 })

  api.nvim_buf_create_user_command(0, "WikiToggleListItem", list.toggle_list_item, { nargs = 0 })

  api.nvim_buf_create_user_command(0, "WikiRenameFile", link.wiki_rename_file, { nargs = 0 })
